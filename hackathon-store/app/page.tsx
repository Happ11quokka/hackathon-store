        ...
        <div className="container mx-auto py-20 md:py-28 px-4">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <Link
                href="/projects"
                className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-white/50 bg-white/10 px-4 h-9 text-sm font-medium text-white hover:bg-white/20 transition-colors w-full sm:w-auto"
              >
